    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError(string.Empty, "User Email exists");
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var modelo = new EditUserViewModel
            {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Owner can`not delete because Property");
                return RedirectToAction(nameof(Index)); 
            }
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "this property have contracts. Verifi");
